<?php
/**
 * TargetPop 'Create Pop-Ups' Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'TargetPop_Create_Pop_Ups_Tab', false ) ) :
/**
 * TargetPop_Create_Pop_Ups_Tab.
 */
class TargetPop_Create_Pop_Ups_Tab {
    ...
    public function __construct() {
		...
		$this->form = new TargetPop_Create_Pop_Up_Form('initial', null);
...
// Instantiate the class
$am = new TargetPop_Create_Pop_Ups_Tab;