...
if ( ! class_exists( 'TargetPop_EditDeleteTriggers_Tab', false ) ) :
/**
 * TargetPop_EditDeleteTriggers_Tab.
 */
class TargetPop_Triggers_Tab {

    public function __construct() {
    	require_once(TARGETPOP_CLASSES_UI_DISPLAY_DIR.'class-ui-display-template.php');
    	require_once(TARGETPOP_CLASSES_UI_DISPLAY_DIR.'class-editdelete-triggers-form.php');
    	// Instantiate the class
		$this->template = new TargetPop_UI_Display_Template;
		$this->form = new TargetPop_EditDelete_Triggers_Form();
    ...
    private function output_open_display_container(){
        $icon_url = TARGETPOP_ROOT_IMG_ICONS_URL.'sketch.svg';
        $title = 'Edit & Delete Triggers';
